...
def main():
    ...
    parser.add_argument("-ta", "--task", nargs="+", default=["deepedit", "deepgrow", "10"], help="The subtask/mode which we want to execute")
    ...
    parser.add_argument("--datetime", default='10072024_182402') #TODO Comment this out
