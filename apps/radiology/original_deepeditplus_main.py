...
def main():
    ...
    parser.add_argument("-m", "--model", default="deepeditplus")
    parser.add_argument("-t", "--test", default="validate")#"train") #"batch_infer", choices=("train", "infer", "batch_infer"))
    parser.add_argument("--infer_run", default='0')
    parser.add_argument("-ta", "--task", nargs="+", default=["deepedit", "autoseg", "10"], help="The subtask/mode which we want to execute, three modes (one is a pseudo mode: deepgrow=initial_deepedit) ")
    ...
    parser.add_argument("--datetime", default='10072024_201348') #, default='27052024_123303') #THIS TOO
