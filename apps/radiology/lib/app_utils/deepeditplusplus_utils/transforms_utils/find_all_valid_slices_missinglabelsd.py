...
Find the valid slices to place clicks in for the initialisation points for each corresponding class.
...
class FindAllValidSlicesMissingLabelsd(MapTransform):
    ...
    Args:
        ...
        version_param: the version of this transform that we are implementing!
    """
