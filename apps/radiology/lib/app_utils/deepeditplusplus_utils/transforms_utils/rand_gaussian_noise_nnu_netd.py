'''
Deprecated: nnU-net was using a misnomer when referring to the std as the variance, therefore the transform was generating extremely noisy images.
'''
...
# '''
# version 1: Standard approach as used by nnu-net v2.4.2 from pip for simulation of Gaussian noise. It samples from a uniform distribution for the selection of the variance,
...
if __name__ == '__main__':
    ...
    from monai.transforms import Compose, EnsureChannelFirstd, Orientationd, LoadImaged, DivisiblePadd, RandGaussianNoised
    ...
    noise_stack = load_stack_base +  [RandGaussianNoised(keys="image", prob=1), DivisiblePadd(keys="image", k=[64,64,32])]
