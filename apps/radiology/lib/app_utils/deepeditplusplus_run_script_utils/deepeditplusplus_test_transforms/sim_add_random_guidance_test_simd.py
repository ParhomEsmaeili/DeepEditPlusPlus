...
Version 1: The DeepEdit++ v1.1 implementation. No modifications made to the hardcoded hyperparametrisations taken from the original deepedit.
Version 2: The DeepEdit++ v1.1 implementation in TORCH? 

'''


class AddRandomTestGuidanceSIMDeepEditd(Randomizable, MapTransform):
    """
